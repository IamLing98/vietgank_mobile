...
export const FOLLOWING: IProduct[] = [
  {
    id: 1,
    type: 'vertical',
    title: 'Vietgangz Horse Club Saigon',
  ...
  },
  {
    id: 2,
    type: 'vertical',
    title: 'Vietgangz Horse Club Hanoi ',
  ...
  },
  {
    id: 3,
    type: 'horizontal',
    title: 'Vietgangz Horse Club Danang',
    address: 'Khu du lịch Đầm Trành – phường Thạch Bàn – Quận Long Biên',
    image:
  ...
  },
  {
    id: 4,
    type: 'vertical',
    title: 'Vietgangz Horse Club Lamdong',
    address: 'Khu du lịch Đầm Trành – phường Thạch Bàn – Quận Long Biên',
    image:
  ...
  },
  {
    id: 5,
    type: 'vertical',
    title: 'Vietgangz Horse Club Phan Thiet',
    address: 'Khu du lịch Đầm Trành – phường Thạch Bàn – Quận Long Biên',
    image:
  ...
  },
  {
    id: 6,
    type: 'horizontal',
    title: 'Vietgangz Horse Club Nha Trang',
    address: 'Khu du lịch Đầm Trành – phường Thạch Bàn – Quận Long Biên',
    image:
...
export const SALE_OFF = [
  {
    _id: '1',
    imageUrl:
      'https://eedpqa938fr.exactdn.com/wp-content/uploads/2021/03/The-SM-Store-3-Day-Sale-50off-Mar18-21.jpg?strip=all&lossy=1&resize=299%2C300&ssl=1',
    description: 'Mua áo Vietgangz tặng quần ',
  },
  {
    _id: '2',
    imageUrl:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjUEKaYeEIbw6HzdD1JZzcO944CXHdCIMUGQ&usqp=CAU',
    description: 'Mua 1 tặng 1',
  },
  {
    _id: '3',
    imageUrl: 'https://i.dawn.com/large/2022/03/6228653dcd486.jpg',
    description: 'Miễn phí vận chuyển hàng nội thành',
  },
];
...
export const PRODUCTS = [
  {
    _id: '1',
    imageUrl:
      'https://vietgangz.com/wp-content/uploads/2022/11/tru%CC%9Bo%CC%9B%CC%81c-510x510.jpg',
    name: 'ZIP HOODIE CARLINER',
    price:580000,
    tags:['Hoodies', 'Tops']
  },
  {
    _id: '2',
    imageUrl:
      'https://vietgangz.com/wp-content/uploads/2023/01/NEW1-1-510x638.jpg',
    name: 'SAMURAI',
    price:580000, 
    tags:['Hoodies', 'Tops']  
  },
  {
    _id: '3',
    imageUrl:
      'https://vietgangz.com/wp-content/uploads/2022/01/1-1-510x510.jpg',
    name: 'Varsity Vietgangz MC',
    price:1200000,
    tags:['Jackets', 'Tops']
  },
  {
    _id: '4',
    imageUrl:
      'https://vietgangz.com/wp-content/uploads/2020/12/bomber111-510x328.jpg',
    name: 'Bomber Jacket Vitara',
    price:459000,
    tags:['Jackets', 'Tops']
  },
];
